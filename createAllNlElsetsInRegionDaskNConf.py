...
if __name__ == '__main__':
    ...
    #number of nodes
    numCompNodes = 2
    cluster = SLURMCluster(cores=numProc, processes=1, memory="24GB", walltime="02:25:00", queue="moorecores", shebang="#!/bin/bash")
    ...
    for i in data:
        dummyIjk = 0
        j = dask.delayed(multiprocessing_func)(i,dummyIjk)
